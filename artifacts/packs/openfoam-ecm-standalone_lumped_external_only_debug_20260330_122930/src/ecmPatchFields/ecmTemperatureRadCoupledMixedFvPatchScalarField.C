...
#include "ecmTemperatureRadCoupledMixedFvPatchScalarField.H"
...
volScalarField&
ecmTemperatureRadCoupledMixedFvPatchScalarField::getOrCreateField
(
...
void ecmTemperatureRadCoupledMixedFvPatchScalarField::storeHTCFields
(
    const word& prefix,
...
void ecmTemperatureRadCoupledMixedFvPatchScalarField::writeFileHeader
(
    Ostream& os
)
{
...
ecmTemperatureRadCoupledMixedFvPatchScalarField::
ecmTemperatureRadCoupledMixedFvPatchScalarField
(
    const fvPatch& p,
...
ecmTemperatureRadCoupledMixedFvPatchScalarField
(
    const ecmTemperatureRadCoupledMixedFvPatchScalarField& psf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
:
    ...
    useDeltaH_(dict.getOrDefault<Switch>("useDeltaH", true))
{
...
void ecmTemperatureRadCoupledMixedFvPatchScalarField::autoMap
(
    const fvPatchFieldMapper& mapper
)
{
...
void ecmTemperatureRadCoupledMixedFvPatchScalarField::rmap
(
...
)
{
    ...
    const ecmTemperatureRadCoupledMixedFvPatchScalarField& tiptf =
        refCast
        <
            const ecmTemperatureRadCoupledMixedFvPatchScalarField
        >(ptf);
...
ecmTemperatureRadCoupledMixedFvPatchScalarField::kappa
(
...
void ecmTemperatureRadCoupledMixedFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void ecmTemperatureRadCoupledMixedFvPatchScalarField::manipulateMatrix
(
    fvMatrix<scalar>& m,
    const label iMatrix,
...
tmp<Field<scalar>> ecmTemperatureRadCoupledMixedFvPatchScalarField::coeffs
(
...
) const
{
    FatalErrorInFunction
        ...
        << "Use compressible::ecmTemperatureRadCoupledMixed "
...
tmp<scalarField>
ecmTemperatureRadCoupledMixedFvPatchScalarField::alphaSfDelta() const
{
    return (alpha(*this)*patch().deltaCoeffs()*patch().magSf());
}


tmp<scalarField> ecmTemperatureRadCoupledMixedFvPatchScalarField::
beta() const
{
    const mappedPatchBase& mpp =
...
bool ecmTemperatureRadCoupledMixedFvPatchScalarField::writeFile()
{
...
void ecmTemperatureRadCoupledMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
    ...
    os.writeEntryIfDifferent<bool>("useDeltaH", true, useDeltaH_);
