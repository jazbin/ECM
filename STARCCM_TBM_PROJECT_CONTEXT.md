...
This root-level file is the canonical project context. `docs/STARCCM_TBM_PROJECT_CONTEXT.md` is a synchronized copy with an additional repository-forensics appendix; factual statements in both files must remain aligned.
